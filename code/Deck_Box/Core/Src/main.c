...
{
	// setting frequency
	int freq_arr = 76000000/(freq*1000);
	TIM2->ARR = freq_arr;
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(TransmitLed_GPIO_Port, TransmitLed_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : TransmitLed_Pin */
  GPIO_InitStruct.Pin = TransmitLed_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(TransmitLed_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : TransmitSwitch_Pin */
  GPIO_InitStruct.Pin = TransmitSwitch_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(TransmitSwitch_GPIO_Port, &GPIO_InitStruct);
